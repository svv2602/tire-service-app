...
export const darkThemeOptions: ThemeOptions = {
  palette: {
    mode: 'dark',
    primary: {
      main: '#3F8CFF', // Яркий голубой, более заметный в темном режиме
      light: '#6DABFF',
      dark: '#0065D2',
      contrastText: '#FFFFFF'
    },
    secondary: {
      main: '#4ADE80', // Яркий зеленый для акцентов
      light: '#7EEEA8',
      dark: '#00A94F',
      contrastText: '#121212'
    },
    error: {
      main: '#FF5252', // Более яркий красный для темной темы
      light: '#FF8A80',
      dark: '#C50E29',
      contrastText: '#FFFFFF'
    },
    warning: {
      main: '#FFB74D', // Более яркий оранжевый
      light: '#FFE97D',
      dark: '#C87D20',
      contrastText: '#121212'
    },
    success: {
      main: '#4CAF50', // Более яркий зеленый
      light: '#80E27E',
      dark: '#087F23',
      contrastText: '#FFFFFF'
    },
    info: {
      main: '#29B6F6', // Яркий голубой для информации
      light: '#73E8FF',
      dark: '#0086C3',
      contrastText: '#121212'
    },
    background: {
      default: '#111827', // Современный темно-синий фон
      paper: '#1F2937'    // Немного светлее для карточек и элементов
    },
    text: {
      primary: '#F3F4F6',
      secondary: '#D1D5DB'
  ...
  shape: {
    borderRadius: 12, // Чуть больше скругление в темной теме
  },
  shadows: [
    'none',
